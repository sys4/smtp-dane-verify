...
def verify_tlsa_resource_record(hostname: str, answers: List[dns.rdtypes.ANY.TLSA.TLSA], addr: Optional[str]=None, openssl: Optional[str]=None) -> VerificationResult:
    if addr is None:
